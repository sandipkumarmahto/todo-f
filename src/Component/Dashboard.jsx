      ...
      <div className="container main-content">
        {!hasTasks ? (
          <div className="empty-state text-center" id="emptyState">
            <img src="https://cdn-icons-png.flaticon.com/512/6194/6194029.png" alt="No tasks" className="empty-state-image mb-4"/>
                  ...
                  <div className="card task-card">
                    <div className="card-body">
                      ...
                      <div className="task-meta">
                        <span> <i className="far fa-calendar me-1"></i> {task.dueDate} </span>
                        <span><i className="far fa-clock me-1"></i>{task.dueTime}</span>
                      </div>
                      <div className="task-actions mt-3">
                        <button className="btn btn-sm btn-outline-success"><i className="fas fa-check" /> </button>
                        <button className="btn btn-sm btn-outline-primary"> <i className="fas fa-edit" /> </button>
